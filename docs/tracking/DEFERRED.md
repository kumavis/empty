...
| 2 | GitHub Pages deployment automation | Raindrop Game design §9 | Out of track scope; repo serves statically as-is | A Pages workflow/config decision by the repo owner |
